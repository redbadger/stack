  ...
  it('should find public services', () => {
    const services = [{
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'charypar/swarm-dashboard:latest@sha256:43e8e22732b1bcd9654b8672bb3e57e21c5a22f695bd8b8e65df14cdbe933528',
      ...
      Endpoint: {
        ...
        VirtualIPs: [{ NetworkID: 'rqhyz2zmtmiz129akzfpb8u8m', Addr: '10.255.0.8/16' }, { NetworkID: 'sgxihewf68xh8pggc44snqkey', Addr: '10.0.1.2/24' }]
      }
    }, {
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'localhost:5000/app_rproxy:latest@sha256:961321670c35519992017eaba8857ebdf9d1be8cda7d7d502b088575ffc8783a',
      ...
      Endpoint: {
        ...
        VirtualIPs: [{ NetworkID: 'rqhyz2zmtmiz129akzfpb8u8m', Addr: '10.255.0.10/16' }, { NetworkID: 'k8kd7mjwinx2kzquki19ref1c', Addr: '192.168.31.6/24' }]
      }
    }, {
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'svendowideit/ambassador:latest@sha256:bb60fceae45493a7ce17c19958a38caf8d5b6869958fc9c7f78885c75f1881cf',
      ...
      Endpoint: {
        ...
        VirtualIPs: [{ NetworkID: 'rqhyz2zmtmiz129akzfpb8u8m', Addr: '10.255.0.6/16' }, { NetworkID: 'ul1oczuiet0oykyxgo4xbp3u9', Addr: '10.0.0.2/24' }]
      }
    }, {
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'localhost:5000/web:latest@sha256:dde7d576282758e76adfee4edc1f895ae3f751cae9c7f2165098b40538c391ae',
            Labels: { 'com.docker.stack.namespace': 'app' },
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'localhost:5000/proxy:latest@sha256:35966190ac3b4cfb758a4e12f7c25c547b4babb0e60994e6660207f080c7b81a',
            Labels: { 'com.docker.stack.namespace': 'app' },
          ...
          Networks: [{ Target: 'k8kd7mjwinx2kzquki19ref1c', Aliases: ['gateway'] }, { Target: 'ro66sxffzd428njh9s01rlahs', Aliases: ['gateway'] }],
          ForceUpdate: 0,
          Runtime: 'container'
        },
        Mode: { Replicated: { Replicas: 3 } },
      ...
      Endpoint: {
        Spec: { Mode: 'vip' },
        VirtualIPs: [{ NetworkID: 'k8kd7mjwinx2kzquki19ref1c', Addr: '192.168.31.2/24' }, { NetworkID: 'ro66sxffzd428njh9s01rlahs', Addr: '192.168.32.2/24' }]
      }
    }, {
      ...
      Spec: {
        ...
        TaskTemplate: {
          ContainerSpec: {
            Image: 'localhost:5000/api:latest@sha256:4089d1869f6ea1ee10b15bd3f509a3b1008b105dbee7f0d2a1c12eaa904817cb',
            Labels: { 'com.docker.stack.namespace': 'app' },
            Env: ['PORT=3000'],
            Privileges: { CredentialSpec: null, SELinuxContext: null },
            Secrets: [{
    ...
    const expected = [{ name: 'visualizer', stack: 'services', port: 8000 }, { name: 'rproxy', stack: 'app', port: 8001 }, { name: 'registry', stack: 'swarm', port: 5000 }];
    const actual = (0, _services.findWithPublishedPorts)(services);
